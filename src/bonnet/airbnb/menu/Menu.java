...
import bonnet.airbnb.outils.Comparaisons;
import bonnet.airbnb.outils.ParserLogementsXML;
...
public class Menu {
	...
	public static void main(String[] args) {
		...
		/*
		 * // On doit faire ça mais on n'est pas obligé... if (maison1 != null) {
		 * maison1.afficher(); }
		 */
		...
		// -----------------------------------------------------------------------------------------
		// Correction 8.1
		Comparaisons<Logement> compareLogement = new Comparaisons<Logement>(appartement1, maison2);
		Logement higherLogement = compareLogement.getHigher();
		higherLogement.afficher();

		Comparaisons<Hote> compareHote = new Comparaisons<Hote>(listHotes.get(0), listHotes.get(1));
		Hote higherHote = compareHote.getHigher();
		higherHote.afficher();
	...
	private static void init() {
		...
		Maison maison1 = new Maison("Maison 21", hote1, 40, "18 Bis rue Romain Rolland, 37230 Fondettes", 140, 2, 500, true);
		Maison maison2 = new Maison("Maison 22", hote1, 35, "146 Rue George Sand, 59553 Cuincy", 120, 2, 200, false);
		Maison maison3 = new Maison("Maison 23", hote1, 60, "13 Rue de la Liberté, 62800 Liévin", 90, 4, 2000, true);
		Appartement appartement1 = new Appartement("Appart 231", hote1, 35, "46 Rue des Canonniers, 59800 Lille", 72, 2, 3, 20);
		Appartement appartement2 = new Appartement("Appart 232", hote1, 35, "111 Rue Colbert, 37000 Tours", 42, 2, 2, 0);
